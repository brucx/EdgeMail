...
function MailboxesPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setShowCreate(false);
      setForm({ localPart: "", domainId: "", displayName: "", canSend: true });
      setError("");
    },
    ...
    <div className="animate-fade-in p-6">
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Mailbox className="h-6 w-6 text-[hsl(var(--primary))]" />
          ...
          <div className="w-full max-w-md rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-6 shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="canSend" className="text-sm">Allow sending emails</label>
              </div>
              ...
              <div className="flex justify-end gap-2">
                ...
                <button
                  type="submit"
                  disabled={createMutation.isPending || !form.localPart || !form.domainId || !form.displayName}
      ...
      {!isLoading && mailboxes.length === 0 && (
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-[hsl(var(--border))] py-24">
          <Mailbox className="mb-4 h-12 w-12 text-[hsl(var(--muted-foreground))]" />
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="mt-0.5 flex items-center gap-3 text-xs text-[hsl(var(--muted-foreground))]">
                    ...
                    <span className={`inline-flex items-center gap-1 ${mb.canSend ? "text-emerald-500" : "text-[hsl(var(--muted-foreground))]"}`}>
